...
On 2026-01-17, this repository was forked from <https://github.com/ropensci-archive/elastic> to explore efforts for maintaining R package `elastic` until such time that a current Lucene-like database could be found and accessed with a current R database adapter. To install this package in R, run
