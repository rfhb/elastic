...
Since then, changes in this repository include updates to code and tests, see [NEWS.md](NEWS.md). 

Package `elastic` is again available from CRAN since 2026-01-25 and can be installed with 
...
To install the development version of package 'elastic' from this repository, run in R
...
This package has been archived on CRAN. The former README is now in [README-not.md](README-not.md).
...
* [Elasticsearch installation help](https://www.elastic.co/docs/deploy-manage/deploy/self-managed/installing-elasticsearch)
...
Obviously, upgrading Elasticsearch while keeping it running is a different thing ([some help here from Elastic](https://www.elastic.co/docs/deploy-manage/upgrade/deployment-or-cluster)).
...
* Please [report any issues or bugs](https://github.com/ropensci-archive/elastic/issues)
* License: MIT
