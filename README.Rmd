...
Since then, changes in this repository include updates to code and tests, see [NEWS.md](NEWS.md). This README file remains to be reviewed and will be updated once package `elastic` is available on CRAN again and the maintainer has been changed. 
