...
- \_primary_first The operation will go and be executed on the primary
...
- \_only_node:xyz Restricts the search to execute only on a node with
...
- \_shards:2,3 Restricts the operation to the specified shards. (2 and 3
  in this case). This preference can be combined with other preferences
  but it has to appear first: \_shards:2,3;\_primary
